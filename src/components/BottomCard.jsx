...
function BottomCard({builder,star,rating,title, caption, para}) {
  return (
    <div style={{display:"flex", marginTop:"14px", justifyContent:"space-around", background:'#ffffff'}}>
    <div style={{width:"25%", display:"flex",flexDirection:'column', alignItems:"center",justifyContent:"center"}}><img src={builder} style={{width:"141px", height:"103px"}}/>
    ...
    <div style={{width:"50%"}} >
      <p style={{fontWeight:"bold"}}>{para}
        ...
        <div className='mid-box'>
           <div><p>9.9</p><span>Building Responsive</span></div>
           <div><p>8.9</p><span>Cool</span></div>
           <div><p>8.9</p><span>Docs</span></div>
        </div>
